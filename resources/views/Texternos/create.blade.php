...
@section("title","Registro de Tutores Externos")

@section("content")
    <h1 class="text-center">Registro de Tutores Externos</h1>
    ...
    <div class="row justify-content-md-center">
        <div class="col-8">
            <form action="{{url("texternos")}}" method="post">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="nombre_te" type="text" class="form-control" name="nombre_te" required autocomplete="new-nombre">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="ap_te" type="text" class="form-control" name="ap_te" required autocomplete="new-ap">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="am_te" type="text" class="form-control" name="am_te" required autocomplete="new-am">
                    </div>
                </div>

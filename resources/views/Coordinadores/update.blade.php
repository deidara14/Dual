...
@section("title","Actualizar Coordinador")

@section("content")
    <h1 class="text-center">Actualizar Registro de Coordinador</h1>
    ...
    <div class="row justify-content-md-center">
        <div class="col-8">
            <form action="{{route("coordinadores.update",$coordinadore->id_coordinador)}}" method="post">
                @csrf
                @method("PUT")
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input value="{{$coordinadore->nombre_c}}" id="nombre_c" type="text" class="form-control" name="nombre_c" required autocomplete="new-nombre">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="ap_c" type="text" class="form-control" name="ap_c" required autocomplete="new-ap" value="{{$coordinadore->ap_c}}">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="am_c" type="text" class="form-control" name="am_c" required autocomplete="new-am" value="{{$coordinadore->am_c}}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="telefono" type="text" class="form-control" name="telefono" required autocomplete="new-telefono" value="{{$coordinadore->telefono}}">
                    </div>
                </div>
